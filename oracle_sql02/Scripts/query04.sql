...
INSERT INTO EMP_SAMPLE VALUES( SELECT  MAX( EMPLOYEE_ID)  FROM EMP_SAMPLE, '홍길동',  NULL,TO_DATE('20220305', 'YYYYMMDD'), 2800, NULL, 80, NULL);

/*
 * 강사님 코드 
 * 
 * INSET INTO EMP_SAMPLE(EMP_ID, EMP_NAME, HIRE_DATE, DEPT_ID, SALARY, COMMISSION_PCT)
 * 						VALUES(SELECT MAX(EMP_ID) + 1 FROM EMP_SAMPLE, '홍길동', TO_DATE(), 80, 2800, NULL)
 * 
 */
/*
...
UPDATE EMP_SAMPLE SET EMAIL = 'GILDONG@emp.co.kr', PHONE = '590-423-4561' WHERE EMPLOYEE_ID = 207;
SELECT * FROM EMP_SAMPLE WHERE EMPLOYEE_ID = '207';
...
SELECT * FROM EMP_SAMPLE WHERE EXTRACT (YEAR FROM HIRE_DATE) < 1990 AND SALARY > 10000;
