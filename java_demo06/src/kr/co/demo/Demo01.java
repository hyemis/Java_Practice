...
public class Demo01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		각각의 객체로 이루어져 잇으며, 발생하는 모든 사건들은
		 * 		객체간의 상호작용으로 이루어져 있다. 이러한 개념을
		 * 		컴퓨터로 옮겨 유사하게 동작하도록 만드는 것을 객체지향 언어
		 * 		라고 한다. 
		 * 
		 * 예시
		...
		// 인스턴스화 : 클래스 객체를 인스터스 객체로 만드는 과정
		Person p1 = new Person();
		Person p2 = new Person();
		
		// 인스턴스 객체의 멤버변수에 데이터를 할당
		p1.name = "홍길동";
		p1.age = 29;
		p2.name = "김철수";
		p2.age = 32;
		 ...
		 * 		protected	: 같은 패키지, 후손관계 까지만 접근 가능
		...
		//p6.personID = "123456789";
		//System.out.println(p6.personID); // personId는 접근 제한자가 private라 접근 불가. 
		
		/*
		 * 캡슐화 : 객체를 외부에서 접근하지 못하게 캡슐처럼 감싸서 보호하는 것
		 * 		  을 캡슐화라고 한다. (객체지향 언어의 3대 특징)
		 * 
		 * 캡슐화를 위해 다음의 원칙을 적용한다. 
		 * 		- 클래스의 멤버 변수에 대한 접근제한은 private로 한다.
		 * 		- 클래스의 멤버 변수에 대한 연산처리를 목적으로 하는 함수들은
		 * 		  클래스 내부에 작성한다. 
		 * 		- 멤버 메서드는 클래스 밖에서 접근 할 수 있드록 public 으로 
		 * 		  설정 한다.
		 * 
		 */
		...
		SmartPhone phone2 = new SmartPhone();  // 멤버변수를 캡슐화 시키고 setter. getter 메서드로 사용.
		phone2.setModel("BMS-4575");
		phone2.setNumber("010-123-4567");
