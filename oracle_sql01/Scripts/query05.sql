/*
* EMPLOYEES 테이블의 직원 이름, 이메일, 전화번호, 고용일을 조회한다. 
* 		- 직원 이름은 성과 이름을 하나의 컬럼으로 만들어야 한다. 
* 		- 이메일 뒤에는 @employess.co.kr 을 붙여야 한다. 
...
/*
 * EMPLOYEES 테이블에서 직원 이름, 급여, 연봉을 조회 한다. 
...
/*
 * LOCATIONS 테이블에서 우편번호가 5자리 숫자 또는 4자리 숫자로 되어 있는 지점을 조회한다.
 */
SELECT *
FROM LOCATIONS
WHERE POSTAL_CODE LIKE '_____' OR POSTAL_CODE LIKE '____';
