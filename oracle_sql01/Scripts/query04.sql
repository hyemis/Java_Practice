...
SELECT SYSDATE AS "현재 날짜"
			, SYSDATE + INTERVAL '5' HOUR AS "5시간 뒤"
			, SYSDATE - INTERVAL '5' HOUR AS "5시간 전"
			, SYSDATE + INTERVAL '50' MINUTE AS "50분 뒤"
			, SYSDATE +INTERVAL '50' MINUTE AS "50분 전"
			, SYSDATE - INTERVAL '50' SECOND  AS "50초 뒤"
FROM DUAL;
			, SYSDATE - INTERVAL '50' SECOND  AS "50초 전"
