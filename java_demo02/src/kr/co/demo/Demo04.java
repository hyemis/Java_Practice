...
public class Demo04 {
	...
	public static void main(String[] args) {
		...
		// .printf() 는 .print() 기능에 특정 형식 (포맷)을 갖추어 출력 할 때 사용
		// .println() 은 .print() 기능을 수행 후 개행(줄바꿈)을 추가 할 때 사용
		
		System.out.print("A");
		System.out.print("B");
		System.out.print("C");
		
		System.out.println(); // 출력 할 때마다 개행
		
		System.out.println("A"); 
		System.out.println("B");
		System.out.println("C");
		
		System.out.printf("%s", "Hello"); // %s 문자열
		System.out.printf("%d", 1234);  // %d 정수형 
		System.out.printf("%s / %d", "Hello", 1234);  // 순서대로 %s - hello, %d - 1234 
		...
		String newTitle = "문자열 나열 중간에 \"큰따움표 또 만나면\""; // 사용하고자 하는 문자열은 "" 안에 넣는다. 문자 1 byte 문자열 1byte 이상 
		System.out.println(newTitle); // ""탈출하기 위해 \ 써준다
